// src/components/shortcuts/ShortcutCard.tsx
import type { ApiShortcut } from "../../types/shortcut";

type Props = {
  shortcut: ApiShortcut;
  onEdit: (shortcut: ApiShortcut) => void;
  onDelete: (shortcut: ApiShortcut) => void;
};
...
export function ShortcutCard({ shortcut, onEdit, onDelete }: Props) {
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="mt-2 flex items-center justify-end gap-2">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="text-[11px] px-2 py-1 rounded-md border border-slate-200 hover:bg-slate-50 transition"
          >
            Abrir
          </a>
          ...
          <button
            ...
            className="text-[11px] px-2 py-1 rounded-md bg-sky-500 text-white hover:bg-sky-600 transition"
          >
            Editar
          </button>
          ...
          <button
            ...
            className="text-[11px] px-2 py-1 rounded-md border border-rose-200 text-rose-600 hover:bg-rose-50 transition"
          >
            Excluir
          </button>
        </div>
