    ...
    <>
      <div className="p-4 sm:p-6">
        <div className="max-w-6xl mx-auto space-y-6">
            ...
            <div className="flex flex-col items-end gap-2">
              ...
              {canViewGenerateButton && (
                <button
                  ...
                  className="inline-flex items-center gap-1.5 rounded-full border border-blue-500 bg-blue-500 px-3 py-1.5 text-xs font-semibold text-white shadow-sm hover:bg-blue-600 disabled:opacity-60"
                >
                  {generating ? (
                    <>
              ...
              <div className="w-full md:max-w-md">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full rounded-xl border border-slate-200 bg-slate-50 px-3 py-2 text-sm text-slate-900 placeholder:text-slate-400 focus:border-blue-400 focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-100"
                  />
                  {loading && (
          ...
          {canViewDownloadButton && (
            <div className="rounded-2xl border border-blue-100 bg-blue-50 px-3 py-3 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="inline-flex items-center gap-1.5 rounded-full border border-blue-600 px-3 py-1.5 text-[11px] font-semibold text-blue-700 hover:bg-blue-600 hover:text-white disabled:opacity-50"
                >
                  {downloading ? (
                    <>
                      <Loader2 className="w-3 h-3 animate-spin" />
      ...
      {showGenerateSuccessModal && (
        <div className="fixed inset-0 z-40 flex items-center justify-center">
          ...
          />
          <div className="relative z-50 w-full max-w-sm mx-4 rounded-2xl bg-white shadow-xl border border-blue-100 p-4">
            ...
            <div className="mt-4 flex justify-end">
              <button
                type="button"
                onClick={() => setShowGenerateSuccessModal(false)}
                className="inline-flex items-center justify-center rounded-full border border-blue-500 px-3 py-1.5 text-xs font-semibold text-blue-700 hover:bg-blue-50"
              >
                Beleza, entendi
              </button>
            </div>
